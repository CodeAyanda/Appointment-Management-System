...
namespace RoughEx {
    ...
    public partial class LoginDS : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/GroupWst15DataSet1.xsd";
...
namespace RoughEx.LoginDSTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Login] WHERE (([USERNAME] = @Original_USERNAME) AND ([PASSWORD] = @O" +
                "riginal_PASSWORD) AND ([NAME] = @Original_NAME))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Login] ([USERNAME], [PASSWORD], [NAME]) VALUES (@USERNAME, @PASSWORD" +
                ", @NAME);\r\nSELECT USERNAME, PASSWORD, NAME FROM Login WHERE (USERNAME = @USERNAM" +
                "E)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Login] SET [USERNAME] = @USERNAME, [PASSWORD] = @PASSWORD, [NAME] = @NAME WHERE (([USERNAME] = @Original_USERNAME) AND ([PASSWORD] = @Original_PASSWORD) AND ([NAME] = @Original_NAME));
SELECT USERNAME, PASSWORD, NAME FROM Login WHERE (USERNAME = @USERNAME)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT USERNAME, PASSWORD, NAME FROM Login";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT USERNAME, PASSWORD, NAME FROM Login WHERE (USERNAME = @USERNAME) AND (PASS" +
                "WORD = @PASSWORD)";
        ...
        public virtual int Fill(LoginDS.LoginDataTable dataTable) {
        ...
        public virtual LoginDS.LoginDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDS.LoginDataTable dataTable = new LoginDS.LoginDataTable();
        ...
        public virtual int CheckLogin(LoginDS.LoginDataTable dataTable, string USERNAME, string PASSWORD) {
        ...
        public virtual LoginDS.LoginDataTable CheckLoginDT(string USERNAME, string PASSWORD) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((USERNAME == null)) {
                throw new global::System.ArgumentNullException("USERNAME");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDS.LoginDataTable dataTable) {
